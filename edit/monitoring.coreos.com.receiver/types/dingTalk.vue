...
<template>
  <div>
    ...
    <div class="row mb-20">
      <div class="col span-12">
        <LabeledInput v-model="value.http_config.secret" :mode="mode" :label="t('monitoringReceiver.pandariaWebhook.dingTalk.secretLabel')" :placeholder="t('monitoringReceiver.pandariaWebhook.dingTalk.secretPlaceholder')" />
      </div>
    </div>
    <div class="row mb-20">
