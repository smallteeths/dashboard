...
export const routerOptions = {
  ...
  routes: [{
    ...
    component: () => interopDefault(import('../pages/c/_cluster/legacy/resourceQuota/_page.vue')),
  ...
  },
  {
    ...
    children:  [
      ...
      },
      {
        ...
        component: () => interopDefault(import('../pages/auth/verify-cas.vue')),
  ...
  },
  {
    ...
    children:  [
      ...
      },
      {
        ...
        component: () => interopDefault(import('../pages/c/_cluster/logging/extension.vue')),
      ...
      },
      {
        ...
        component: () => interopDefault(import('../pages/c/_cluster/manager/globalMonitoring/index.vue')),
        name:      'c-cluster-manager-globalMonitoring'
      }, {
        path:      '/c/:cluster/manager/globalMonitoring/dashboard',
        component: () => interopDefault(import('../pages/c/_cluster/manager/globalMonitoring/_dashboard.vue')),
        ...
        component: () => interopDefault(import('../pages/c/_cluster/explorer/navLinks/_page.vue')),
