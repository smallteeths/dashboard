...
describe('model: apps.deployment rollback', () => {
  it('should ignore some labels and annotations', async() => {
    ...
    expect(rollBackWorkload.mock.calls[0][2][0].value.metadata.annotations).toStrictEqual({});
    expect(rollBackWorkload.mock.calls[0][2][0].value.metadata.labels).toStrictEqual({});
  });
  ...
  it('should have correct labels and annotations', async() => {
    ...
    expect(rollBackWorkload.mock.calls[0][2][0].value.metadata.annotations).toStrictEqual({ others: 'others' });
    expect(rollBackWorkload.mock.calls[0][2][0].value.metadata.labels).toStrictEqual({ others: 'others' });
  });
});
