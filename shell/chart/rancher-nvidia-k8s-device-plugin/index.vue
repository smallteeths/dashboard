...
<template>
  <div>
    <Tab name="container-images" :label="t('rancher-nvidia-k8s-device-plugin.titles.image')" :weight="3">
      <div class="row mb-10">
    ...
    <Tab name="device-plugin-options" :label="t('rancher-nvidia-k8s-device-plugin.titles.plugin')">
      <Tabbed
        ref="configs"
        :side-tabs="true"
    ...
    <Tab name="gfd-options" :label="t('rancher-nvidia-k8s-device-plugin.titles.gfd')">
      <div class="row">
        <div class="col span-6">
          <Checkbox
    ...
    <Tab name="schedule-options" :label="t('rancher-nvidia-k8s-device-plugin.titles.schedule')">
      <div class="row">
