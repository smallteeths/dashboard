  ...
  <div class="nodepool-type-wrap">
    ...
    <div class="type-config">
      ...
      <NativeNodePoolForm
        ...
        :systemDiskTypeOptions="systemDiskTypeOptions"
        :dataDiskTypeOptions="dataDiskTypeOptions"
        ...
        @update:dataDiskType="emit('update:dataDiskType', $event)"
        @update:dataDiskSize="emit('update:dataDiskSize', $event)"
