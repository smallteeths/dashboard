...
import Summary from '@pkg/image-repo/components/v1/Summary.vue';
import ImageStore from '@pkg/image-repo/components/v1/ImageStore.vue';
import Member from '@pkg/image-repo/components/v1/Member.vue';
import Labels from '@pkg/image-repo/components/v1/Labels.vue';
import Logs from '@pkg/image-repo/components/v1/Log.vue';
