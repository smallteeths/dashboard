...
import AwsS3, { answers as s3Answers } from '@/components/ThanosStorageProviders/AwsS3';
import AliyunOss, { answers as ossAnswers } from '@/components/ThanosStorageProviders/AliyunOss';
import Gcs, { answers as gcsAnswers } from '@/components/ThanosStorageProviders/Gcs';
import TencentcloudCos, { answers as cosAnswers } from '@/components/ThanosStorageProviders/TencentcloudCos';
import Azure, { answers as azureAnswers } from '@/components/ThanosStorageProviders/Azure';
...
<template>
  <div>
    ...
    <template v-if="objectStorageEnabled">
      ...
      <div class="mb-20">
        <h3 class="mb-20">
          <t k="formScheduling.toleration.workloadTitle" :workload="thanosStore" />
        </h3>
        <div class="row">
          <Tolerations
      ...
      <div class="mb-20">
        <h3 class="mb-20">
          <t k="formScheduling.toleration.workloadTitle" :workload="thanosCompact" />
        </h3>
        <div class="row">
          <Tolerations
